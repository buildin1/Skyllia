...
public class PostgreSQLIslandCustomData extends IslandCustomDataQuery {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLIslandCustomData.class);
    ...
    public PostgreSQLIslandCustomData(DatabaseLoader databaseLoader) {
