...
modrinth {
    ...
    additionalFiles.set(
        listOf(
            ...
            project(":addons:SkylliaUpgrade").tasks.named<Jar>("shadowJar"),
            project(":addons:SkylliaTrader").tasks.named<Jar>("shadowJar"),
...
tasks.modrinth {
    dependsOn(
        ...
        ":addons:SkylliaUpgrade:shadowJar",
        ":addons:SkylliaTrader:shadowJar",
